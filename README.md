...
| `skills/python-authoring/SKILL.md` | `/python-authoring` | Write, edit, or review Python as concise, stdlib-first, fully typed code: validate input once at the boundary, model it with frozen dataclasses, prefer succinct idioms, de-slop, and pass basedpyright with zero errors and warnings. |
