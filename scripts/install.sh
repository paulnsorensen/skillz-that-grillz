...
SG_FALLBACK_SKILLS="bash-shortening commit gh gh-bootstrap github-copilot-personal-instructions github-copilot-repo-instructions gt justfile prek safe-settings"
